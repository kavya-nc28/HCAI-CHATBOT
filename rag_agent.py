...
agent = Agent(
    ...
    system_prompt="You are a helpful assistant that answers questions based on the provided documentation. "
                  "Use the retrieve tool to get relevant information from the documentation before answering.When ever you give answers from the document provide the links of the documents from where you fetch the information "
